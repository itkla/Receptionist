...
export default function RequestPasswordResetPage() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    // Basic email format check (optional, API does more)
    if (!/^[^\\s@]+@[^\\s@]+\.[^\\s@]+$/.test(email)) {
    ...
    try {
      ...
      // Always show a generic success message for security (don't confirm if email exists)
      ...
      // Show specific error from API or a generic one
